        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group left-form-group">
                                                ...
                                                0<span id="telefono" class="v telefono_remitente"></span>
                                                <br>
                                                <a href="#" id="enlace" onclick="enviarwhatsapp('v telefono_remitente')">Whatsapp</a>
                                            </div>
                                        </div> <!--col-->
                                    </div> <!--row-->
                                    <div class="row">
                                ...
                                <div class="grey-box top10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group left-form-group">
                                                <label class="font-medium"><?php echo Driver::t("Teléfono") ?>:</label>
                                                0<span id="telefono2" class="v telefono_recibe"></span>
                                                <br>
                                                <a href="#" id="enlace" onclick="enviarwhatsapp2('v telefono_recibe')">Whatsapp</a>
                                            </div>
                                        </div> <!--col-->
                                    </div> <!--row-->
                                    <div class="row">
                ...
                <div class="panel-footer top20 task-action-button">       
                    <div class="row">
                        <div class="col-md-4">
                            <a href="#no" class="blue-button edit2">
                                <?php echo t("Editar") ?>
                            </a>
                        </div> <!--row-->

                        <div class="col-md-4">
                            <a href="#no" class="blue-button cambiar-estado-orden">
                                <?php echo t("Cambiar Estado") ?>
                            </a>
                        </div> <!--row-->
                        <div class="col-md-4">
                            <a href="#no" class="green-button migrar-de-ruta">
                                <?php echo t("Cambiar de Rutas") ?>
                            </a>
                        </div> <!--row-->
                    ...
                    <div class="row top10">
                        ...
                        <div class="col-md-4">
                            <a href="#no" class="orange-button cambiar-fecha-envio">
                                <?php echo t("Cambiar Fecha Envío") ?>
                            </a>
                        </div> <!--row-->
                        <div class="col-md-4">
                            <a href="#no" class="blue-button cambiar-fecha-entrega">
                                <?php echo t("Cambiar Fecha Entrega") ?>
                            </a>
                        </div> <!--row-->
                        <div class="col-md-4">
                            <a href="#no" class="yellow-button imprimir-comprobante">
                                <?php echo t("Comprobante") ?>
                            </a>
                        </div> <!--row-->
                    </div> <!--row-->
                </div>
...
<script>
    function enviarwhatsapp(valor){
    //alert(document.getElementById('telefono').innerText);   
    window.open(`https://wa.me/593${document.getElementById('telefono').innerText}`, '_blank');
    } 

    function enviarwhatsapp2(valor){
    //alert(document.getElementById('telefono').innerText);   
    window.open(`https://wa.me/593${document.getElementById('telefono2').innerText}`, '_blank');
    } 
</script>