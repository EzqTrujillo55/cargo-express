<?php $this->pageTitle = Yii::app()->name . ' - Contactos'; ?>
//<?php
$this->renderPartial('/app/detalle-contacto', array(
));
?>
<?php
$this->renderPartial('/app/new-contacto', array(
));
?>
<?php
...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        ...
        Yii::app()->clientScript->registerScriptFile(
                Yii::app()->baseUrl . '/assets/contactos.js', CClientScript::POS_END
        );
        ?>
    </div> <!--content_2-->
