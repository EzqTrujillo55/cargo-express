...
<?php
$this->renderPartial('/app/detalle-orden', array(
));
?>
<?php
...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <div class="row">
                        ...
                        <div class="col-3"><a class="green-button left rounded" href="<?php echo Yii::app()->createUrl('/app/export_pedidos_todos') ?>"><?php echo t("Export") ?></a>  </div>
        ...
        <div class="inner">
            <form id="frm_table_todas_ordenes" class="frm_table">
                <?php echo CHtml::hiddenField('action', 'pedidosTodosList') ?>
                <table id="table_list" class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo t("Mensajero Asignado") ?></th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="s009">
                    <form  id="frm_table_todas_ordenes_busqueda" class="frm_table">
                        <?php echo CHtml::hiddenField('action', 'pedidosTodosFilteredList') ?>
