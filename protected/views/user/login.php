...
<div class="container">
    <div class="login-wrap rounded">
        ...
        <form id="frm-forgotpass" class="frm rounded3" method="POST" onsubmit="return false;">
            ...
            <div class="sub-section">
                <a href="#no" class="show-login"><?php echo t("Atrás") ?></a>
            </div>

        </form> <!--forgot pass-->

        <hr/>
        <p class="center black"><?php echo t("No tiene cuenta") ?>?</p>

        <a href="<?php echo Yii::app()->createUrl('front/registro') ?>" class="yellow-button large rounded3 relative">
            <?php echo Driver::t("REGISTRO GRATIS") ?> <i class="ion-ios-arrow-thin-right"></i>
        </a>
